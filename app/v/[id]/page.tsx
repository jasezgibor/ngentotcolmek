...
const jsonLd = {
        ...
        url: `https://ngentotcolmek.pages.dev/v/${file.filecode}`,
        ...
        interactionStatistic: {
            ...
            interactionType: {
                '@type': `WatchAction`,
                target: `https://ngentotcolmek.pages.dev/v/${file.filecode}`
            }  
        }
        }
        const jsonLd2 = {
